...
strategy:
  en: "Automated public-layer scanning + LLM-assisted signal classification + structured PDF output. Deployed on Railway + Netlify. Payments via LemonSqueezy."
  es: "Escaneo automatizado de capa pública + clasificación de señales asistida por LLM + output PDF estructurado. Desplegado en Railway + Netlify. Pagos vía LemonSqueezy."
  pt: "Varredura automatizada de camada pública + classificação de sinais assistida por LLM + output PDF estruturado. Implantado no Railway + Netlify. Pagamentos via LemonSqueezy."
vision:
...
results:
  - metric: "$12"
    label:
      en: "Per compliance audit report"
      es: "Por informe de auditoría de compliance"
      pt: "Por relatório de auditoria de compliance"
  - metric: "Ley 21.719"
    label:
      en: "Chilean data protection compliance"
      es: "Compliance Ley de Protección de Datos Chile"
      pt: "Conformidade Lei de Proteção de Dados Chile"
  - metric: "Live"
    label:
      en: "In production · LemonSqueezy integrated"
      es: "En producción · LemonSqueezy integrado"
      pt: "Em produção · LemonSqueezy integrado"
featured: true
date: "2026-04"
