...
> **Prerequisite reading:** `CLAUDE.md`, `docs/brand/dna/BRAND-FOUNDATION.md`, `docs/SERVICE-CATALOG.md`, `docs/IA-RULES.md`
...
- `docs/brand/dna/BRAND-FOUNDATION.md` — Voice, positioning, glosario de poder. If copy you write conflicts with this, it's wrong.
- `docs/SERVICE-CATALOG.md` — Service model, pricing, ROI Audit mechanics. Don't invent services or pricing.
...
const proof = defineCollection({
  ...
  schema: z.object({
    ...
    solution_systems: z.array(z.string()), // must match SERVICE-CATALOG.md system names
...
**ES copy:** translate with equivalent force. Use "soberanía digital" (already in `docs/brand/dna/BRAND-FOUNDATION.md` glosario).
...
**Data source:** `docs/SERVICE-CATALOG.md` (sections: Systemic Alchemy, Narrative Delivery, Zero-Leak Architecture, AI Orchestration, Productive Friction).
