...
```mermaid
flowchart LR
    L[Lead] --> D[Diagnóstico online<br/>gratis · califica]
    D -->|qualified/borderline| A[ROI Audit real<br/>sesión + business case]
    A --> P[Propuesta<br/>aglaya-os:proposal]
    P --> C[Cierre:<br/>instalación + retainer]
    D -->|no-fit| O[Canal abierto / Web / nurture]
```
