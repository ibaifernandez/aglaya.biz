...
- **Environment Variables**: Configure all keys required by the active platform docs (Resend, hCaptcha, Sentry) in the Netlify dashboard.
- **Service Integration**: Follow `./3rd-parties-config/PLATFORMS-CONFIG.md` and `./3rd-parties-config/NETLIFY-CONFIG.md` for Resend, hCaptcha, Sentry and Netlify environment setup.
...
3.  **Bot Protection**: Added hCaptcha to prevent spam.
