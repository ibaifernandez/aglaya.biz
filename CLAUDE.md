...
**Último pase del capitán: 2026-07-17** — verificado el 7/7 de cohesión tras el lote #102–#107; actualizado el estado de firmas del canónico (§10: Scanner cerrado, CRM pendiente formal); huella colocada. Detalle: entrada del 17-jul en `docs/ops/CHANGELOG.md`.
